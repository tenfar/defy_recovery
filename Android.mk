...
RECOVERY_VERSION := GoAPK Defy Recovery v2.5.1.2
RECOVERY_VERSION_GOAPK := Support:www.goapk.com
RECOVERY_VERSION_QUN := QQ Qun:15389310
LOCAL_CFLAGS += -DRECOVERY_VERSION="$(RECOVERY_VERSION)"
LOCAL_CFLAGS += -DRECOVERY_VERSION_GOAPK="$(RECOVERY_VERSION_GOAPK)"
LOCAL_CFLAGS += -DRECOVERY_VERSION_QUN="$(RECOVERY_VERSION_QUN)"
LOCAL_CFLAGS += -DBOARD_GOAPK_DEFY="$(BOARD_GOAPK_DEFY)"
endif
